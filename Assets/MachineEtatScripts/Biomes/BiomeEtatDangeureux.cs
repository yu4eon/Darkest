...
/// </summary>
public class BiomeEtatDangeureux : BiomesEtatsBase
{
    Material _matCube; // Matériel du cube
    ...
    public override void TriggerEnterEtat(BiomesEtatsManager biome, Collider other)
    {
        ...
        // {
        //     Debug.Log("Le joueur est entré dans le biome dangeureux");
        //     biome.infos["perso"].GetComponent<Perso>().PrendreDegats(10);
